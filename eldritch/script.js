...
class Deck{
    constructor(){
        ...
        this.stageArr=[];
        this.deck = [];
        this.stageArr.push(document.querySelectorAll('.green'));
        this.stageArr.push(document.querySelectorAll('.brown'));
        this.stageArr.push(document.querySelectorAll('.blue'));
    ...
    setScheme(scheme, lvl){  
        ...
        switch(lvl){
            case 'very-easy':
            case 'easy':
            this.sortedCard.green = this.cardsGreen.filter(e=>{
                if(e.difficulty === 'easy' || e.difficulty === 'normal'){
                    return e;
                }  
            })
            this.sortedCard.brown = this.cardsBrown.filter(e=>{
                if(e.difficulty === 'easy' || e.difficulty === 'normal'){
                    return e;
                }  
            })
            this.sortedCard.blue = this.cardsBlue.filter(e=>{
                if(e.difficulty === 'easy' || e.difficulty === 'normal'){
                    return e;
                }  
            })          
            break;
            case 'normal':
            this.sortedCard.green = this.cardsGreen;
            this.sortedCard.brown = this.cardsBrown;
            this.sortedCard.blue = this.cardsBlue;
            break;
            case 'hard':
            case 'very-hard':
            this.sortedCard.green = this.cardsGreen.filter(e=>{
        ...
        let stageCards = [];
        for (const key in this.sortedCard){
            this.sortedCard[key]
        }
    }
    #random(){
